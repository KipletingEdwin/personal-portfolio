      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-md text-sm font-light text-slate-400">
            Have an interesting project layout or engineering role? Drop a secure transmission message below.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-5 lg:gap-16">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <div className="flex items-start gap-4 rounded-xl border border-white/5 bg-brand-card/40 p-5 bg-card-glow shadow-md">
              ...
              <div>
                <h4 className="text-sm font-semibold tracking-wide text-white">Email Address</h4>
                <a href="mailto:contact@mstm.studio" className="mt-1 block text-sm font-light text-slate-400 hover:text-brand-neon-blue transition-colors duration-200">
                  contact@mstm.studio
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 rounded-xl border border-white/5 bg-brand-card/40 p-5 bg-card-glow shadow-md">
              ...
              <div>
                <h4 className="text-sm font-semibold tracking-wide text-white">Direct Line</h4>
                <a href="tel:+1234567890" className="mt-1 block text-sm font-light text-slate-400 hover:text-brand-coral transition-colors duration-200">
                  +1 (234) 567-890
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 rounded-xl border border-white/5 bg-brand-card/40 p-5 bg-card-glow shadow-md">
              ...
              <div>
                <h4 className="text-sm font-semibold tracking-wide text-white">Location Hub</h4>
            ...
            >
              ...
              {submitStatus === 'success' && (
                <div className="rounded-lg bg-emerald-500/10 border border-emerald-500/20 px-4 py-3 text-sm font-medium text-emerald-400 animate-fade-in">
                  Secure transmission dispatched successfully! I will respond shortly.
                </div>
              )}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Tell me about your system scope or design mockup specifications..."
              ...
              <div className="pt-2">
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      Transmit Message
                      <svg className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
